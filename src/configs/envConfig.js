...
const envVars = {
  production: {
    ...
    OCEAN_MARKET_NETWORK: 'mainnet',
    OCEAN_MARKET_CHAIN_ID: '1',
    OCEAN_MARKET_METADATA_URI: 'https://aquarius.mainnet.oceanprotocol.com/',
  ...
  staging: {
    ...
    OCEAN_MARKET_NETWORK: 'rinkeby',
    OCEAN_MARKET_CHAIN_ID: '4', // rinkeby
    OCEAN_MARKET_METADATA_URI: 'https://aquarius.rinkeby.oceanprotocol.com/',
